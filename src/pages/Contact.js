...
const Contact = () => {
  return (
    <div className="bg-medium-gray">
      <ContactNavbar />
      <div className="layout-bg px-6 md:px-12 lg:px-16 pb-[200px] lg:pb-[300px] xl:pb-[360px]">
        <div className="flex flex-col lg:flex-row justify-between gap-y-12 mt-10 side-pages-container mx-auto">
