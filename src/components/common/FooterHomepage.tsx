...
const FooterHomepage = () => {
  return (
    <>
      <footer className="pb-32 pt-32 md:pt-24 lg:pt-36 xl:pt-52 bg-lightest-white-bg footer-bg relative custom-padding">
        <div className="footer-gorila">
          <img src={require("../../assets/images/gorila-footer.png")} alt="" />
        </div>
        <a
          href="/"
          className="mb-16 md:mb-24 flex justify-center md:justify-start homepage-container mx-auto px-6 md:px-8 "
        >
          <img src={logo} alt="logo" width="130px" height="auto" />
        </a>
        <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4 homepage-container mx-auto px-6 md:px-8 ">
      ...
      {/* <div className="bg-red-100 h-[300px] z-100 mt-[-200px]"></div> */}
    </>
  );
};
