...
const Hero = () => {
  return (
    <section className="px-6 md:px-8 text-light-white homepage-container mx-auto">
      <div className="mx-auto flex py-16 md:py-12 md:flex-row flex-col items-center relative">
        <div className="hidden md:block slide-right lg:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
          ...
          <p
            className="mb-12 leading-relaxed w-full text-light-white border-l-4 border-light-green pl-4 xl:text-lg"
            data-aos="fade-left"
            data-aos-once="true"
        ...
        <div className="block md:hidden absolute top-[230px] slide-right lg:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
          <h1 className="text-5xl xl:text-6xl mb-4 font-bold text-light-white uppercase mt-8">
            Become an <br />
            <span className="text-light-green">SFT Trader!</span>
            <br className="hidden lg:inline-block" />
